...
//            Forneça uma única resposta (responda somente o que for perguntado, sem alucinar):
//            """;
...
//
//        String[] near = getNearTexts(promptInput);
//        NearTextArgument nearText = NearTextArgument.builder()
//                .concepts(near).distance(0.4F).build();
//        ;
//
//        try {
...
//
//        String prompt = "Com base nesse prompt, me retorne  apenas, se houver: nome do bairro, nome da cidade, nome do estado, crimes, coisas relacionadas a criminalidade. Me de em string, apenas com um único valor:" + "\n\n" + promptUser;
...
//    }
//
//    public String generateFinalSummaryGemini(String promptUser, String resultadosCombinados, List<Map<String, Object>> structuredData, String apiKey) {
//        String url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro-latest:generateContent?key=" + apiKey;
//        Map<String, Object> requestBody = new HashMap<>();
//        Map<String, Object> contents = new HashMap<>();
//        Map<String, Object> parts = new HashMap<>();
//
//        String context = "Você é um analista de dados criminais, na qual é capaz de analisar qualquer tipo de dados. Eu extrai os dados da SSP e colocarei aqui para você.";
//        String prompt = "Com base nos dados a seguir e somente neles, responda, de forma hipotetica(responda só o que usuario pedir, sem alucinar): " + promptUser
//                + "\nResultados combinados:\n\n" +resultadosCombinados+ "\n\nDados estruturados: " + structuredData;
//
